...
public class QueryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// Set the result attribute in the request
         ...
         // ResultSet's cursor now pointing at first row
            do {
               ...
               out.println("<td class='align-middle'>"
                     ...
                     + "if (&euro(this).hasClass('increment'))"
	           ...
	           do {
	            ...
	            // Pass total price as a request attribute
	            request.setAttribute("totalPrice", totalPrice);

	            // Store the selected products in the session
	            HttpSession session = request.getSession();
	            session.setAttribute("selectedProducts", result);

	            // Forward the request back to the QueryServlet to display products
	            RequestDispatcher rd1 = request.getRequestDispatcher("QueryServlet");
	 ...
	 */
	 @Override
	    protected void doPost(HttpServletRequest request, HttpServletResponse response)
	        ...
	        HttpSession session = request.getSession();
	        ResultSet selectedProducts = (ResultSet) session.getAttribute("selectedProducts");

	        // Forward the request to the shopping cart page
