...
@WebServlet("/CreateDeliveryTable")
public class CreateDeliveryTable extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "CREATE TABLE IF NOT EXISTS deliveryTable (id INT AUTO_INCREMENT PRIMARY KEY, "
                    + "name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, "
                    + "address1 VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, "
                    + "phone VARCHAR(20) NOT NULL, email VARCHAR(255) NOT NULL, "
                    + "order_date DATE NOT NULL, ordered_items TEXT)"; // Add new column 'ordered_items'
