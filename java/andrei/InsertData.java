...
public class InsertData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
            ...
            for (int i = 1; i <= 315; i++) { // Assuming there are 315 products
                String imageURL = "img_product/" + "product_image_" + i + ".npg"; // Construct image URL dynamically
                out.println("<li><img src='" + imageURL + "' alt='Product Image'></li>");
            }
